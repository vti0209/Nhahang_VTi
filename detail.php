...
<head>
    ...
    <meta name="title" content="VTi Restaurant - VTi Restaurant"/>
    <meta name="description" content="VTi Restaurant - VTi Restaurant" />
    <meta name="keywords" content="VTi Restaurant - VTi Restaurant" />
                        ...
                        <div class="detail-product">
                            <div class ="row">
                                ...
                                <div class="col-md-7 col-xs-6 col-xs-12">
                                    ...
                                    ?>
                                        <p class ="price">Giá cũ: <?php echo number_format($row['price'], 0, ',', '.'); ?><sup>đ</sup></p>
                                        <p class ="price">Khuyến mãi giảm còn: <?php echo number_format($gia, 0, ',', '.'); ?><sup>đ</sup></p>
                                    <?php
                                        } else
                                        {
                                    ?>
                                        <p class ="price">Giá sản phẩm: <?php echo number_format($row['price'], 0, ',', '.'); ?><sup>đ</sup></p>
                                    <?php
                                        }
                                    ?>
                                    <hr>
