            ...
            <div class= "col-md-12 col-sm-16 col-xs-12">
                ...
                <form name="form-lien-he" action ="lienhe_back.php" method ="POST" accept-charset="utf-8">
                    <div class="contents">
                        ...
                        <center><button type="submit" style="background:linear-gradient(45deg,#00B4D8,#0077B6); border:none; color:white;" name="sendcontact" class="btn btn-info"> Gửi liên hệ </button></center>
                    </div><!-- /content -->
                </form>
            </div><!-- /col -->
        </div><!-- /row -->
