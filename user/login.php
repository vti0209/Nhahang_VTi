	...
	<header>
	    <div class="container-fluid header_top wow bounceIn" data-wow-delay="0.1s">
	        <div class="col-sm-10 col-md-10">
	            <div class="header_top_left"> <span><i class="fa fa-phone"></i></span> <span>(+84) 5733.533.523 |  (+84) 373.532.152</span>&nbsp;&nbsp;&nbsp; <span><i class="fa fa-envelope-o" aria-hidden="true"></i></span> <span>QuanLy43@VTirestaurant.com.vn</span> </div>
	        </div>
	    ...
	    <div class="container">
	        <!-- Logo -->
	        <div class="title">
	            <a href="../index.php" title="VTiRestaurant"> <img src="../images/logohong.png" width="260px;" height="180px;"> </a>
	        </div>
	        <!-- /logo -->
	            ...
	            <div class="container-fluid">
	                ...
	                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	                    <ul class="nav navbar-nav">
	                        ...
	                        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Ẩm Thực<b class="fa fa-caret-down"></b></a>
		...
		<div class="row">
			...
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				<div class="panel panel-danger">
						...
						<form action="login-back.php" method="post" name="form-login" accept-charset="utf-8">
							<div class="row">
								<div class="col-sm-12 col-md-10 col-md-offset-1">
									...
									<p>
									<a href="../forgotpass.php">Bạn quên mật khẩu?</a></p>
									<div class="form-group">
					...
					<div class="panel-footer">
						<p>Admin VTi Restaurant. Vui lòng <a href="../admin/login.php" onclick=""> Đăng nhập </a></p>
					</div><!-- /panel-footer -->
